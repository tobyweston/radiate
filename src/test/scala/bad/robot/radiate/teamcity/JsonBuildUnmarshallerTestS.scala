...
class JsonBuildUnmarshallerTestS extends Specification with IsolatedMockFactory {

  val response = stub[HttpResponse]
  val unmarshaller = new JsonBuildUnmarshallerS
  ...
  "Unmarhsall regular build" >> {
    ...
    val buildType = BuildTypeScala("Example_Qa", "QA", "/guestAuth/app/rest/buildTypes/id:Example_Qa", "Example", "Example")
    build must_== BuildS("465", "159", "/guestAuth/app/rest/builds/id:465", "SUCCESS", "Success", "20130726T150432+0100", Some("20130726T150541+0100"), buildType, None)
  }
  ...
  "Unmarshall a running build" >> {
    ...
    val build = unmarshaller.unmarshall(response)
    val buildType  = BuildTypeScala("Example_Qa", "QA", "/guestAuth/app/rest/buildTypes/id:Example_Qa", "Example", "Example")
    val runInformation = Some(RunInformationS(9, 7, 85, false, false))
  ...
  "Unmarshall outdated build" >> {
    ...
    val build = unmarshaller.unmarshall(response)
    val buildType = BuildTypeScala("Example_Qa", "QA", "/guestAuth/app/rest/buildTypes/id:Example_Qa", "Example", "Example")
    val runInformation = Some(RunInformationS(9, 7, 85, true, false))
    build must_== BuildS("465", "159", "/guestAuth/app/rest/builds/id:465", "SUCCESS", "Step 1/1", "20130726T161108+0100", None, buildType, runInformation)
  }
