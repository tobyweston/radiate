...
import bad.robot.radiate.ui.PotentiallySingleRowOfTiles.tiles
import bad.robot.radiate.ui.TilesMatcher.requiresGridOf
import org.specs2.mutable.Specification

class PotentiallySingleRowOfTilesTest extends Specification {
