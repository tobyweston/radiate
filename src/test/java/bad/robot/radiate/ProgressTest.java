...
public class ProgressTest {
    ...
    public void showTheNumberOfThingsProgressIsOver() {
        assertThat(new Progress(0, 200).numberOfBuilds(), is(1));
        assertThat(new Progress(0, 100).add(new Progress(50, 300)).numberOfBuilds(), is(2));
        assertThat(new Progress(0, 100).add(new Progress(20, 100)).add(new Progress(50, 300)).numberOfBuilds(), is(3));
    }

    @Test
    public void ignoreNumberOfThingsWhenNullObjectIsUsed() {
        assertThat(new Progress(0, 0).numberOfBuilds(), is(1));
        assertThat(new Progress(0, 0).add(new Progress(0, 0)).numberOfBuilds(), is(2));
        assertThat(new Progress(0, 0).add(new NullProgress()).numberOfBuilds(), is(1));
        assertThat(new Progress(0, 0).add(new NullProgress()).add(new NullProgress()).numberOfBuilds(), is(1));
    }
