...
public class Composite {
     ...
     */
    public static AlphaComposite transparentComposite(Graphics2D graphics, Transparency transparency) {
        return transparency.createAlphaComposite((AlphaComposite) graphics.getComposite());
    }

    public static AlphaComposite transparentComposite(Transparency transparency) {
